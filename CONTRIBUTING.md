...
The gates are the four commands in `.githooks/pre-commit`; CI in `.github/workflows/ci.yml` adds Release, pack, consumer, NativeAOT and coverage lanes. Releases follow [RELEASING.md](RELEASING.md).
