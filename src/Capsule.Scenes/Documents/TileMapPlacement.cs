...
/// <param name="ZIndex">
/// The authored draw band, applied to the composed <see cref="Tiles.TileMap"/>'s
/// <see cref="Entity.ZIndex"/>; 0 is the unbanded default.
/// </param>
public readonly record struct TileMapPlacement(int Id, TileGrid Grid, int ZIndex = 0);
