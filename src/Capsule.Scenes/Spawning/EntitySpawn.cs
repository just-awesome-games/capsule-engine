...
/// entity's constructor's decision — a <see cref="Rendering.SpriteRenderer.Scale"/>, a collider
/// shape run through <see cref="Collision.Shape2D.Scaled"/>, or nothing at all.
/// </param>
