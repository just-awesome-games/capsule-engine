...
// positions. A renderer draws it as if by the frame's camera with its centre moved to
// ScrollCenter + (Centre - ScrollCenter) * ScrollFactor, where the centre is that of the world rect the
