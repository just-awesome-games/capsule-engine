...
/// <summary>
/// When a document was first and last persisted, taken from the host's wall clock at the flush with its
/// local offset. This is host state, not simulation input.
/// </summary>
