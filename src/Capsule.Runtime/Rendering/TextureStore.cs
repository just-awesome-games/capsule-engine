...
internal sealed class TextureStore(GraphicsDevice device) : IDisposable
{
    ...
    /// </summary>
    /// <exception cref="FileNotFoundException">An added handle's file is not beside the executable.</exception>
    ...
    /// <exception cref="InvalidOperationException">The current scene's set does not hold it.</exception>
