...
namespace Capsule.Runtime.Audio.Vorbis
{
    ...
    // </summary>
    abstract internal class DataPacket : IPacket
    {
        // <summary>
        ...
        // Capsule: a pooled Packet (Ogg/Packet.cs) is reused across every packet a provider
        // reads. It needs a way to drop the previous use's flags and derived state along with
        // its bit-read position. Reset() alone leaves _packetFlags, ContainerOverheadBits and
        // GranulePosition holding the prior packet's values.
