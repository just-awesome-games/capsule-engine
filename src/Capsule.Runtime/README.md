...
Contains: host bootstrapping, fixed-step scheduling, input sampling, driven play, the headless runner, rendering, sound playback, scene hosting, development diagnostics and crash logging.
...
The development overlay lives under `DevTools/` and is off under `CapsuleShipping`; [`docs/debugging.md`](../../docs/debugging.md) covers it.
