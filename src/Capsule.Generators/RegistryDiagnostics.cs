...
internal static class RegistryDiagnostics
{
    ...
    internal static readonly DiagnosticDescriptor DuplicateSceneDocumentName = new(
        "CAP005",
    ...
    internal static readonly DiagnosticDescriptor SceneDocumentRequiresContentConstructor = new(
        "CAP007",
