...
internal static class RegistryProviderSource
{
    ...
    // The provider an assembly is reached through, and the two attributes a shell reads its
    // registry metadata out of. Every member here is called only by generated code.
