...
Contains: the build targets, `Capsule.Generators` (including the analyzer), and this assembly — the key pass, the scene and sprite sheet document process and the audio importer the targets run, packed unlisted under `tools/`.
