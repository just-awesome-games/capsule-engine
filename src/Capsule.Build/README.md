...
Contains: the build targets, `Capsule.Generators` (including the analyzer), and this assembly — the scene and sprite sheet document process and the audio importer the targets run, packed unlisted under `tools/`.
