...
internal sealed record SpriteSheetFrame(string Name, TextureRegion Region, Vector2 Pivot);
...
internal sealed record SpriteSheetClipFrame(string Frame, int Ticks);
...
internal sealed record SpriteSheetClip(string Name, bool Loop, IReadOnlyList<SpriteSheetClipFrame> Frames);
