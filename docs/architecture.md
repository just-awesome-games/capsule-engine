...
| `Capsule.Scenes` | The world: scenes, entities, components, camera, spawning, transitions, tile grids, colliders, and the [scene document](scenes.md) — format, loader, composition. | Core, Collision |
