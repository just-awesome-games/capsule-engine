...
// One small font the text specs share: two ASCII glyphs that kern against each other, one glyph
// outside the Basic Multilingual Plane, and one page.
internal static class FontFixtures
{
    ...
    internal static BitmapFont Font() =>
        new(LineHeight, 8, [Page], [B, A, Emoji], [AgainstB]);
}
