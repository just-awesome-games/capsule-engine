...
public sealed class HdTransition : Scene
{
    ...
    public sealed class HdPageA() : TransitionHalf<HdPageB>(CapsuleAssets.Textures.HdPageA, 512, 160f, World.HdViewportSize, 96);

    /// <summary>The half drawing <c>hd-page-b</c>.</summary>
    public sealed class HdPageB() : TransitionHalf<HdPageA>(CapsuleAssets.Textures.HdPageB, 512, 160f, World.HdViewportSize, 96);
}
