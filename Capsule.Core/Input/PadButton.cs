...
/// binding means the same place on the pad whatever the player is holding. Values must stay
/// below <see cref="DeviceSnapshot.PadCapacity"/>; the backend maps each one.
/// </summary>
